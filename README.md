...
[![BuildStatus](http://www.bioconductor.org/shields/build/devel/bioc/bioCancer.svg?label=bioC)](https://bioconductor.org/checkResults/devel/bioc-LATEST/bioCancer/)
...
[![Travis-CI Build Status](https://travis-ci.org/kmezhoud/bioCancer.svg?branch=master?label= Travis)](https://travis-ci.org/kmezhoud/bioCancer)
...
[![total](https://img.shields.io/badge/downloads-1759/total-blue.svg?style=flat)](https://bioconductor.org/packages/stats/bioc/bioCancer)
